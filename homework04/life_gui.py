"""
Game of Life GUI implementation using Pygame.
...
class GUI(UI):
    """Pygame-based graphical user interface for Game of Life."""
    ...
    def draw_grid(self) -> None:
        ...
        for i in range(self.life.rows):
            ...
            for j in range(self.life.cols):
                ...
                pygame.draw.rect(screen, cell_color, (x_position, y_position, width, height))
